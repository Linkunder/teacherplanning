...
class AnotacionController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Anotacion');
	...
	{
		$model=Anotacion::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Anotacion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='anotacion-form')
		{
